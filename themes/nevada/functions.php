...
if(function_exists( 'set_revslider_as_theme' )){
    ...
    add_action( 'init', 'ut_set_revslider' );
    
    function ut_set_revslider() {
...
if ( !function_exists( 'lambda_header_scripts' ) ) {
	...
	function lambda_header_scripts() {
			...
			if(!is_admin()) {
				...
				$javascripts  .= wp_enqueue_script("jquery-effects-core");
...
function lambda_setup() {
	...
	#-----------------------------------------------------------------
	load_theme_textdomain( 'Nevada' , STYLE_DOCUMENT_ROOT  . '/languages' );

	$locale = get_locale();
	$locale_file = STYLE_DOCUMENT_ROOT  . "/languages/$locale.php";
