			...
			<div class="six columns">
				...
				<div class="lambda-opttitle">
					...
					<div class="lambda-opttitle-pad">
						<?php _e( 'Choose Header Type', 'Nevada' ); ?>
					</div>
				...
				<div class="slider_type_details">		
					...
					$slidertype = array (
                        ...
                        'static_shortcode' 	=> __( 'Custom Shortcode', 'Nevada' )
					);
					...
					#-----------------------------------------------------------------
					?>	
                    <div id="static_shortcode" class="ss_box">
                        
                        <div class="lambda-opttitle">
						    <div class="lambda-opttitle-pad">
							    <?php _e( 'Shortcode', 'Nevada' ); ?>
							</div>
						</div>
                        ...
                        <div class="lambda-settings-pad">
                            ...
                            <p>
                                <label><?php _e( 'Shortcode', 'Nevada' ); ?></label>
                                <?php $mb->the_field('static_shortcode'); ?>
...
<div class="slider_type_background ten columns">
	...
	<div class="lambda-opttitle">
		<div class="lambda-opttitle-pad">
			<?php _e( 'Hide Teaser / Page Title?', 'Nevada' ); ?>
		</div>
	</div>
	...
	<div class="lambda-opttitle">
		<div class="lambda-opttitle-pad">
			<?php _e( 'Background Settings', 'Nevada' ); ?>
		</div>
	</div>
