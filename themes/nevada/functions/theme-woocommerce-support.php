...
if ( ! function_exists( 'nevada_woocommerce_button_proceed_to_checkout' ) ) {
	 ...
	 * @subpackage	Cart
	 */
	function nevada_woocommerce_button_proceed_to_checkout() {
		$checkout_url = WC()->cart->get_checkout_url();

		?>
		<a href="<?php echo $checkout_url; ?>" class="checkout-button woo-button alt wc-forward"><?php _e( 'Proceed to Checkout', 'woocommerce' ); ?></a>
		<?php
	}

    add_action( 'nevada_woocommerce_proceed_to_checkout', 'nevada_woocommerce_button_proceed_to_checkout', 20 );
