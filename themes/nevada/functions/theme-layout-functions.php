...
if ( ! function_exists( 'customSliderBackground' ) ) {
	function customSliderBackground() {
		...
		if($backgroundtype == 'slider_default_backgroundpattern' && !empty( $backgroundpattern ) ) {
		
			 echo '#lambda-featured-header-wrap { background: url('.THEME_WEB_ROOT.'/images/pattern/'.$backgroundpattern.') repeat; }';
		
		} elseif($backgroundtype == 'slider_default_backgroundimage' && !empty( $backgroundimage['background-image'] ) ) {
		...
		} elseif($backgroundtype == 'slider_default_backgroundtexture' && !empty( $backgroundtexture ) ) {
